...
class LugarClima {
  ...
  // Formatea temperatura con signo + cuando corresponde
...
class WeatherApp {
  ...
  _initLugares() {
    return [
      {
        id: "sol", nombre: "Sol", img: "assets/img/sol.png", modifier: "hot",
      ...
      {
        id: "mercurio", nombre: "Mercurio", img: "assets/img/mercurio.png", modifier: "warm",
      ...
      {
        id: "venus", nombre: "Venus", img: "assets/img/venus.png", modifier: "hot",
      ...
      {
        id: "tierra", nombre: "Tierra", img: "assets/img/tierra.png", modifier: "mild",
      ...
      {
        id: "marte", nombre: "Marte", img: "assets/img/marte.png", modifier: "cold",
      ...
      {
        id: "jupiter", nombre: "Júpiter", img: "assets/img/jupiter.png", modifier: "cold",
      ...
      {
        id: "saturno", nombre: "Saturno", img: "assets/img/saturno.png", modifier: "cold",
      ...
      {
        id: "urano", nombre: "Urano", img: "assets/img/urano.png", modifier: "frozen",
      ...
      {
        id: "neptuno", nombre: "Neptuno", img: "assets/img/neptuno.png", modifier: "frozen",
      ...
      {
        id: "55-cancri-e", nombre: "55 Cancri e", img: "assets/img/55 Cancri e.png", modifier: "hot",
      ...
      {
        id: "HD_189733_b", nombre: "HD 189733 b", img: "assets/img/HD_189733_b.png", modifier: "hot",
      ...
      {
        id: "OGLE-2005-BLG-390Lb", nombre: "OGLE-2005-BLG-390Lb", img: "assets/img/OGLE-2005-BLG-390Lb.png", modifier: "frozen",
        ...
        col.innerHTML = `
          <article class="card h-100">
            ...
            <div class="card-body text-center">
              ...
              ${lugar.usaApiReal ? `<span class="badge bg-success mb-2" style="font-size:0.65rem;">🌐 Datos reales (Open-Meteo)</span><br>` : ""}
              <a href="detalle.html?planeta=${lugar.id}" class="btn btn-primary btn-planeta mt-1">Ver más</a>
            </div>
          </article>`;
  ...
  async renderDetalle() {
    ...
    const [nombreEl, imagenEl, descEl, tempEl, breadcrumb, pronosticoContainer, statsContainer] =
      ["nombre-planeta", "imagen-planeta", "descripcion-planeta", "temperatura",
       "breadcrumb-planeta", "pronostico-semanal", "estadisticas-semana"].map(el);
    ...
    try {
      ...
      if (pronosticoContainer)
        pronosticoContainer.innerHTML = `<p class="text-danger text-center">⚠️ Error al cargar datos: ${err.message}</p>`;
      return;
    }

    if (!lugar) {
      if (pronosticoContainer)
        pronosticoContainer.innerHTML = `<p class="text-warning text-center">Planeta no encontrado.</p>`;
      return;
    }

    // Datos básicos del planeta
    ...
    Object.assign(tempEl.style, {
      ...
      borderRadius: "20px", padding: "6px 16px", display: "inline-block", fontWeight: "700",
    });
    ...
    const alertasHTML = alertas.map((a) => `
      <div class="d-flex align-items-start gap-2 mb-2 p-2"
           style="background:rgba(255,255,255,0.04);border-radius:8px;border-left:3px solid ${a.color};">
  ...
  // Botón "Conocer temperatura actual" en la vista de detalle
  initBtnTemperatura() {
  ...
  // Botones de scroll suave arriba/abajo
  initScrollBtns() {
